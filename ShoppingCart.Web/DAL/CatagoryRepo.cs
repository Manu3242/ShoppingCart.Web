...
namespace ShoppingCart.Web.DAL
{
    public class CatagoryRepo
    {
        ...
        public CatagoryRepo(CartDBContext cartDBContext)
        {
        ...
        public bool UpdateCatagory(int Id, Catagory catagory) //new data
        {
            try
            {
                var data = GetCatagoryId(Id);           //old data
                if (data != null)
                {
        ...
        public bool DeleteCatagorye(int Id)
        {
            try
            {
